...
| *`tShirtSizeDefinitions`* __xref:{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-tshirtsizedefinitions[$$TShirtSizeDefinitions$$]__ | 
|===
...
| *`dbTShirtSize`* __TShirtSize__ | T-shirt size, one of small, medium, large
|===
...
[id="{anchor_prefix}-github-com-redhatinsights-clowder-apis-cloud-redhat-com-v1alpha1-tshirtsizedefinitions"]
==== TShirtSizeDefinitions 
...
|===
| Field | Description
| *`small`* __string__ | Small size definition
| *`medium`* __string__ | Medium size definition
| *`large`* __string__ | Large size definition
|===
